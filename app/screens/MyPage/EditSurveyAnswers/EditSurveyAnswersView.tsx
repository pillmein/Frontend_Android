...
import * as S from "./EditSurveyAnswers.style";
import { FontAwesome } from "@expo/vector-icons";
import {
  Header,
  PageIndicator,
  EditSurveySuccessModal,
} from "../../../components";
...
const EditSurveyAnswersView = function ({ navigation }: any) {
...
export default EditSurveyAnswersView;
